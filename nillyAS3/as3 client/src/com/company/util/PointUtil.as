package com.company.util
{
   ...
   public class PointUtil
   {
      ...
      public static const _17Q_:Point = new Point(0,0);
      ...
      public static function _1n7(param1:Point) : Point
      {
      ...
      public static function _4(param1:Point, param2:Point) : Number
      {
         return getDistanceSqr(param1.x,param1.y,param2.x,param2.y);
      }
      
      public static function getDistanceSqr(param1:Number, param2:Number, param3:Number, param4:Number) : Number
      {
      ...
      public static function _1a(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number) : Point
      {
         return new Point(param1 + (param3 - param1) * param5,param2 + (param4 - param2) * param5);
      }
      
      public static function _f5(param1:Point, param2:Point) : Number
      {
         return Math.atan2(param2.y - param1.y,param2.x - param1.x);
      }
      
      public static function _1xy(param1:Point, param2:Number, param3:Number) : Point
      {
