   ...
   public class Base64
   {
      ...
      public static function encodeByteArray(param1:ByteArray) : String
      {
         ...
         while(param1.bytesAvailable > 0)
         {
            ...
            _loc7_[0] = (_loc2_[0] & 252) >> 2;
            _loc7_[1] = (_loc2_[0] & 3) << 4 | _loc2_[1] >> 4;
            _loc7_[2] = (_loc2_[1] & 15) << 2 | _loc2_[2] >> 6;
            _loc7_[3] = _loc2_[2] & 63;
            ...
            {
               _loc6_ = _loc6_ + BASE64_CHARS.charAt(_loc7_[_loc5_]);
               _loc5_++;
            }
         }
         return _loc6_;
      ...
      public static function decodeToByteArray(param1:String) : ByteArray
      {
         ...
         while(_loc7_ < param1.length)
         {
            ...
            _loc6_[0] = (_loc5_[0] << 2) + ((_loc5_[1] & 48) >> 4);
            _loc6_[1] = ((_loc5_[1] & 15) << 4) + ((_loc5_[2] & 60) >> 2);
      ...
      public static function decodeToByteArrayB(param1:String) : ByteArray
      {
         ...
         while(_loc7_ < param1.length)
         {
            ...
            {
               _loc5_[_loc2_] = BASE64_CHARS.indexOf(param1.charAt(_loc7_ + _loc2_));
               while(_loc5_[_loc2_] < 0 && _loc7_ < param1.length)
               {
                  _loc7_++;
                  _loc5_[_loc2_] = BASE64_CHARS.indexOf(param1.charAt(_loc7_ + _loc2_));
               }
