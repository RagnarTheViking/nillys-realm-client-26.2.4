package com.hurlant.crypto.hash
{
   ...
   public class MD2 implements IHash
   {
      ...
      public function hash(param1:ByteArray) : ByteArray
      {
         ...
         var _loc6_:uint = uint(16 - param1.length % 16) || uint(16);
         do
         {
         ...
         while(_loc6_ < _loc7_)
         {
            ...
            while(_loc2_ < 16)
            {
               _loc9_ = _loc8_[_loc2_] = _loc8_[_loc2_] ^ S[param1[_loc6_ + _loc2_] ^ _loc9_];
               _loc2_++;
            }
            _loc6_ = _loc6_ + 16;
         }
         ...
         while(_loc6_ < _loc7_)
         {
            ...
            while(_loc2_ < 16)
            {
               _loc10_[32 + _loc2_] = (_loc10_[16 + _loc2_] = param1[_loc6_ + _loc2_]) ^ _loc10_[_loc2_];
               _loc2_++;
            }
            _loc3_ = 0;
            _loc2_ = 0;
            while(_loc2_ < 18)
            {
               ...
               while(_loc4_ < 48)
               {
                  _loc3_ = _loc10_[_loc4_] ^ S[_loc3_];
                  _loc10_[_loc4_] = _loc3_;
                  _loc4_++;
               }
               _loc3_ = _loc3_ + _loc2_ & 255;
               _loc2_++;
            }
            _loc6_ = _loc6_ + 16;
         }
