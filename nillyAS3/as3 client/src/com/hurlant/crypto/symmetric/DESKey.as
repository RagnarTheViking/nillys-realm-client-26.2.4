package com.hurlant.crypto.symmetric
{
   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         {
            _loc4_ = pc1[_loc12_];
            _loc10_[_loc12_] = (param2[param3 + (_loc4_ >>> 3)] & bytebit[_loc4_ & 7]) != 0;
            _loc12_++;
         }
         while(_loc13_ < 16)
         {
            ...
            _loc6_ = _loc5_ + 1;
            _loc9_[_loc5_] = _loc9_[_loc6_] = 0;
            _loc12_ = 0;
            while(_loc12_ < 28)
            {
               _loc4_ = _loc12_ + totrot[_loc13_];
               if(_loc4_ < 28)
               {
                  _loc11_[_loc12_] = _loc10_[_loc4_];
               }
               else
               {
                  _loc11_[_loc12_] = _loc10_[_loc4_ - 28];
               }
               _loc12_++;
            }
            _loc12_ = 28;
            ...
            while(_loc12_ < 24)
            {
               if(_loc11_[pc2[_loc12_]])
               {
                  _loc9_[_loc5_] = _loc9_[_loc5_] | bigbyte[_loc12_];
               }
               if(_loc11_[pc2[_loc12_ + 24]])
               {
                  _loc9_[_loc6_] = _loc9_[_loc6_] | bigbyte[_loc12_];
               }
               _loc12_++;
            }
            _loc13_++;
         ...
         while(_loc13_ != 32)
         {
            ...
            _loc8_ = _loc9_[_loc13_ + 1];
            _loc9_[_loc13_] = (_loc7_ & 16515072) << 6 | (_loc7_ & 4032) << 10 | (_loc8_ & 16515072) >>> 10 | (_loc8_ & 4032) >>> 6;
            _loc9_[_loc13_ + 1] = (_loc7_ & 258048) << 12 | (_loc7_ & 63) << 16 | (_loc8_ & 258048) >>> 4 | _loc8_ & 63;
            _loc13_ = _loc13_ + 2;
         }
         return _loc9_;
      }
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         while(_loc10_ < 8)
         {
            ...
            _loc6_ = _loc6_ ^ param1[_loc10_ * 4 + 0];
            _loc9_ = SP7[_loc6_ & 63];
            _loc9_ = _loc9_ | SP5[_loc6_ >>> 8 & 63];
            _loc9_ = _loc9_ | SP3[_loc6_ >>> 16 & 63];
            _loc9_ = _loc9_ | SP1[_loc6_ >>> 24 & 63];
            _loc6_ = _loc7_ ^ param1[_loc10_ * 4 + 1];
            _loc9_ = _loc9_ | SP8[_loc6_ & 63];
            _loc9_ = _loc9_ | SP6[_loc6_ >>> 8 & 63];
            _loc9_ = _loc9_ | SP4[_loc6_ >>> 16 & 63];
            _loc9_ = _loc9_ | SP2[_loc6_ >>> 24 & 63];
            _loc8_ = _loc8_ ^ _loc9_;
            _loc6_ = _loc8_ << 28 | _loc8_ >>> 4;
            _loc6_ = _loc6_ ^ param1[_loc10_ * 4 + 2];
            _loc9_ = SP7[_loc6_ & 63];
            _loc9_ = _loc9_ | SP5[_loc6_ >>> 8 & 63];
            _loc9_ = _loc9_ | SP3[_loc6_ >>> 16 & 63];
            _loc9_ = _loc9_ | SP1[_loc6_ >>> 24 & 63];
            _loc6_ = _loc8_ ^ param1[_loc10_ * 4 + 3];
            _loc9_ = _loc9_ | SP8[_loc6_ & 63];
            _loc9_ = _loc9_ | SP6[_loc6_ >>> 8 & 63];
            _loc9_ = _loc9_ | SP4[_loc6_ >>> 16 & 63];
            _loc9_ = _loc9_ | SP2[_loc6_ >>> 24 & 63];
