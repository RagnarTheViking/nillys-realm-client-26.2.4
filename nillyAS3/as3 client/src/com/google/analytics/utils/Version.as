package com.google.analytics.utils
{
   public class Version
   {
      ...
      public static function fromString(param1:String = "", param2:String = ".") : Version
      {
         ...
         var _loc4_:Version = new Version();
         ...
         if(param1.indexOf(param2) > -1)
         {
            ...
            _loc4_.major = parseInt(_loc3_[0]);
            _loc4_.minor = parseInt(_loc3_[1]);
            _loc4_.build = parseInt(_loc3_[2]);
            _loc4_.revision = parseInt(_loc3_[3]);
         }
         else
         {
            _loc4_.major = parseInt(param1);
         }
         return _loc4_;
      }
