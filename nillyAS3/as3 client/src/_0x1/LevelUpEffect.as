package _0x1
{
   ...
   public class LevelUpEffect extends ParticleEffect
   {
      ...
      private static const _1g__:int = 2000;
      ...
      override public function update(param1:int, param2:int) : Boolean
      {
         ...
         var _loc3_:Number = (param1 - this.startTime_) / _1g__;
         if(_loc3_ >= 1)
         {
            this._0qq();
            return false;
         }
         this._024(this.parts1_,1,0,_loc3_);
         this._024(this.parts2_,1,Math.PI,_loc3_);
         return true;
      }
      ...
      public function _024(param1:Vector.<LevelUpParticle>, param2:Number, param3:Number, param4:Number) : void
      {
         var _loc5_:int = 0;
