package _0S_w
{
   ...
   public class _1u5 extends Sprite
   {
      ...
      private static const _1Q_h:int = 600 - _056._0lO_ - 10;
      
      public static const _0O_6:Stats = new Stats();
       
      
      public var _aO_:_0tD_;
      
      private var _1t3:_0lK_;
      
      public var _1o5:_056;
      
      public var _0ji:_00A_;
      
      public var _1zF_:_1xS_;
      
      public var _1dD_:_c2;
      
      public var _yy:_X_D_;
      
      public var _Y_4:_03k;
      
      public var _1T_l:_0Z_o;
      ...
      public function _1u5()
      {
         ...
         this._1o5.x = 800 / 2 - _056._0lO_ / 2;
         this._1o5.y = _1Q_h;
         addChild(this._1o5);
         this._0ji = new _00A_(this._1o5);
         this._0ji.x = 4;
         this._0ji.y = 600 - _00A_.HEIGHT - 10;
         addChild(this._0ji);
         this._1zF_ = new _1xS_(new <String>["Ground","Objects","Regions"],_0Z_o.WIDTH,26);
         this._1zF_.x = this._1o5.x + _056._0lO_ + 4;
         this._1zF_.y = _1Q_h;
      ...
      private function _0hC_(param1:Event) : void
      {
         ...
         var _loc13_:Rectangle = new Rectangle(int(_056._0eO_ / 2 - _loc11_ / 2),int(_056._0eO_ / 2 - _loc12_ / 2),_loc11_,_loc12_);
         this._1o5.clear();
         this._1t3.clear();
