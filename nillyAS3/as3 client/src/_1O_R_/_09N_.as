package _1O_R_
{
   ...
   public class _09N_ extends Sprite
   {
      ...
      public function _09N_(param1:String, param2:String, param3:String, param4:String, param5:String)
      {
      ...
      protected function initText(param1:String) : void
      {
         ...
         var _loc2_:SText = new SText(param1).setPrefix("<p align=\"center\">").setPostfix("</p>");
      ...
      private function _0nv() : void
      {
         if(this._1lC_ != null)
         {
            this.leftButton = new Button(16,this._1lC_,120,true);
            this.leftButton.addEventListener(MouseEvent.CLICK,this._0gd);
         }
         if(this._0J_S_ != null)
         {
            this.rightButton = new Button(16,this._0J_S_,120,true);
