package _1k1
{
   ...
   public class ReskinCharacterView extends Sprite
   {
      ...
      private const _0kQ_:_1S_m = _1Y_p();
      
      private const background:_03K_ = _1L_c();
      
      private const title:SimpleText = _1lN_();
      
      private const list:_zp = _1lZ_();
      
      private const cancel:Button = _1E_s();
      
      private const select:Button = _X_v();
      
      public const _1J_l:Signal = new NativeMappedSignal(cancel,MouseEvent.CLICK);
