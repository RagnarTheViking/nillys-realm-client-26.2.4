package _T_n
{
   ...
   public class _1gJ_ extends _0sZ_
   {
      ...
      public function _1gJ_(param1:String, param2:int, param3:int, param4:int, param5:Boolean = false)
      {
         ...
         super();
         this._11P_ = param1;
         this.text = new SimpleText().setSize(param2).setColor(3552822).setBold(true);
         this._01T_.push(this.text.textChanged);
         var _loc6_:_1eo = param1 != ""?this._10T_.setParams(param1,{"cost":param3.toString()}):this._0bB_.setString(param3.toString());
      ...
      override public function setPrice(param1:int, param2:int) : void
      {
         ...
         if(this.price != param1 || this.currency != param2)
         {
            ...
            _loc3_ = this._11P_ != ""?this._10T_.setParams(this._11P_,{"cost":param1.toString()}):this._0bB_.setString(param1.toString());
