package _A_4
{
   ...
   public class CharacterSkinListItem extends Sprite
   {
      ...
      private const background:Shape = this._1L_c();
      
      private const _C_z:Sprite = this._1qL_();
      
      private const _J_f:SimpleText = this._1Q_y();
      
      private const _D_t:_0fJ_ = this._18c();
      
      private const _09T_:Bitmap = this._0s__();
      
      private const _1Y_b:SimpleText = this._tt();
      
      private const _0G_E_:Sprite = this._gL_();
      
      private const _1L_N_:_A_4._1x5 = this._bs();
      
      public const buy:Signal = new NativeMappedSignal(this._0G_E_,MouseEvent.CLICK);
      
      public const _nU_:Signal = new Signal();
      
      public const out:Signal = new Signal();
      
      public const selected:Signal = this._D_t._my;
