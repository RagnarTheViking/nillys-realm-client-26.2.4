package _A_4
{
   ...
   public class _P_8 extends Sprite
   {
      ...
      private const base:_0O_M_ = this._1G_Y_();
      
      private const account:TitleBasicAccountInfo = this._16M_();
      
      private const _1yx:Shape = this._0t2();
      
      private const _if_:CurrencyDisplay = this._1nE_();
      
      private const _0jB_:ScreenGraphic = this._sN_();
      
      private const _1ad:TextButton = this._0W_G_();
      
      private const _0Y_b:TextButton = this._1st();
      
      private const list:_A_4._zp = this._1lZ_();
      
      private const _by:_A_4.ClassDetailView = this._0U_P_();
      
      public const play:Signal = new NativeMappedSignal(this._1ad,MouseEvent.CLICK);
      
      public const back:Signal = new NativeMappedSignal(this._0Y_b,MouseEvent.CLICK);
      
      public const _01T_:_1S_m = this._1E_S_();
