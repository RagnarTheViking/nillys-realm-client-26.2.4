package _P_N_
{
   ...
   public class CaretakerQueryDialog extends Sprite
   {
      ...
      private const caretaker:_1uS_ = this._qy();
      ...
      private const _1D_r:Button = this._C_r();
      
      public const closed:Signal = new NativeMappedSignal(this._1D_r,MouseEvent.CLICK);
