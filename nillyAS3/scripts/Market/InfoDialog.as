package Market
{
   ...
   public class InfoDialog extends Sprite
   {
      ...
      private const query:Market.InfoDialogQuery = this._qy();
      
      private const title:SimpleText = this._1lN_();
      
      private const _16P_:_W_c = this._0i9();
      
      private const BackBtn:Button = this.CreateBackButton();
      
      private const CloseBtn:Button = this.CreateCloseButton();
      
      public const closed:Signal = new NativeMappedSignal(this.CloseBtn,MouseEvent.CLICK);
