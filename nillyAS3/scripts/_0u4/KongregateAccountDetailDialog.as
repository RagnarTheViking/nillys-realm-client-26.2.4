package _0u4
{
   ...
   public class KongregateAccountDetailDialog extends Sprite
   {
      ...
      public function _G_z(param1:String, param2:String, param3:Boolean) : void
      {
         ...
         _loc4_ = new Frame(_1O_I_._0G_5,"",_1O_I_._s8,"/kongregateCurrentLogin");
         addChild(_loc4_);
         this._0S___ = new SimpleText().setSize(18).setColor(11776947);
         this._0S___.setBold(true);
         this._0S___.setStringBuilder(new _dU_().setParams(_1O_I_._0G_5));
         ...
         if(param3)
         {
            ...
            this._0t8.setStringBuilder(new _dU_().setParams(_1O_I_._1H_U_));
            this._0t8.filters = [new DropShadowFilter(0,0,0)];
            this._0t8.y = _loc4_.h_ - 60;
            this._0t8.x = 17;
            _loc4_.addChild(this._0t8);
            this._1H_A_ = new SimpleText().setSize(16).setColor(11776947).setTextWidth(238).setTextHeight(30);
         ...
         {
            this._cx = new _03S_(12,false,_1O_I_._1I_F_);
