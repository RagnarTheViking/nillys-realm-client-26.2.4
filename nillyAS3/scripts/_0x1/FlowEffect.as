package _0x1
{
   ...
   public class FlowEffect extends ParticleEffect
   {
      ...
      public function FlowEffect(param1:_H_Q_, param2:GameObject, param3:int)
      {
         super();
      ...
      override public function runNormalRendering(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            _loc4_ = new FlowParticle(0.5,_loc3_,this.color_,this.start_,this.go_);
