package _0x1
{
   ...
   public class FountainEffectBlue extends ParticleEffect
   {
      ...
      public function FountainEffectBlue(param1:GameObject)
      {
         super();
         this.go_ = param1;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:FountainParticleBlue = null;
         ...
         {
            _loc3_ = _loc5_ * 50;
            _loc4_ = _1C_q._1I_j(FountainParticleBlue) as FountainParticleBlue;
...
class FountainParticleBlue extends Particle
{
