package _1U_P_
{
   ...
   public class _18w extends Sprite
   {
      ...
      private const _0yz:_I_a = this._1K_();
      
      private const _4M_:SText = new SText();
      
      private const _Y_y:_I_a = this._1K_f();
      
      private const _0T_f:Timer = new Timer(1000);
      
      private const _0yZ_:Sprite = new Sprite();
      
      private const _0D_h = this._1A_q();
      
      private const _1t:_I_a = this._P_L_();
      
      private const _0gC_:_I_a = this._0R_j();
      
      private const _M_M_:_I_a = this._08S_();
