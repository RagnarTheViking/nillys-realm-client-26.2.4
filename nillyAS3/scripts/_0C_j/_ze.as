package _0C_j
{
   ...
   public class _ze extends Sprite
   {
      ...
      private const background:DisplayObject = this._1L_c();
      
      private const title:SimpleText = this._1lN_();
      
      private const _25:SimpleText = this._088();
      
      private const _08A_:SimpleText = this._aJ_();
      
      private const close:Button = this._C_r();
