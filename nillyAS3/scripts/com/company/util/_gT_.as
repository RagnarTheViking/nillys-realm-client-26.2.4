package com.company.util
{
   ...
   public class _gT_
   {
      ...
      public function _gT_(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         super();
         this.x0_ = param1;
         this.y0_ = param2;
      ...
      public static function _1cE_(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Boolean
      {
      ...
      public static function _0Q_6(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number) : Boolean
      {
         ...
         return _0z2(param1,param2,param3,param4,param7,param8,param9,param10) || _0z2(param3,param4,param5,param6,param7,param8,param9,param10) || _0z2(param5,param6,param1,param2,param7,param8,param9,param10);
      }
      
      private static function _0z2(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Boolean
      {
         var _loc9_:Number = NaN;
         var _loc10_:Number = NaN;
         var _loc11_:Number = NaN;
         var _loc12_:Number = NaN;
         var _loc13_:Number = (param4 - param2) / (param3 - param1);
         var _loc14_:Number = param2 - _loc13_ * param1;
         if(_loc13_ > 0)
         {
            _loc9_ = _loc13_ * param5 + _loc14_;
            _loc10_ = _loc13_ * param7 + _loc14_;
         }
         else
         {
            _loc9_ = _loc13_ * param7 + _loc14_;
            _loc10_ = _loc13_ * param5 + _loc14_;
         }
         if(param2 < param4)
         {
            _loc11_ = param2;
         ...
         var _loc15_:Number = _loc9_ > _loc11_?Number(_loc9_):Number(_loc11_);
         var _loc16_:Number = _loc10_ < _loc12_?Number(_loc10_):Number(_loc12_);
         return _loc15_ < _loc16_ && !(_loc16_ < param6 || _loc15_ > param8);
      }
      
      public function _cg() : Rectangle
      {
      ...
      public function _08h() : Number
      {
         return Math.abs((this.x0_ * (this.y1_ - this.y2_) + this.x1_ * (this.y2_ - this.y0_) + this.x2_ * (this.y0_ - this.y1_)) / 2);
      }
      
      public function _hA_(param1:Point) : void
      {
         var _loc2_:Number = PointUtil.getDistance(this.x1_,this.y1_,this.x2_,this.y2_);
         var _loc3_:Number = PointUtil.getDistance(this.x0_,this.y0_,this.x2_,this.y2_);
         var _loc4_:Number = PointUtil.getDistance(this.x0_,this.y0_,this.x1_,this.y1_);
      ...
      public function distance(param1:Number, param2:Number) : Number
      {
         ...
         return Math.min(_0eI_._sq(param1,param2,this.x0_,this.y0_,this.x1_,this.y1_),_0eI_._sq(param1,param2,this.x1_,this.y1_,this.x2_,this.y2_),_0eI_._sq(param1,param2,this.x0_,this.y0_,this.x2_,this.y2_));
      }
      
      public function _0uX_(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         return _0Q_6(this.x0_,this.y0_,this.x1_,this.y1_,this.x2_,this.y2_,param1,param2,param3,param4);
      }
   }
}
