package com.company.assembleegameclient.engine3d
{
   ...
   public class Line3D
   {
      ...
      public function _1I_Q_(param1:Line3D) : int
      {
      ...
      public function _Y_c(param1:Number) : Vector3D
      {
...
class UnitTest
{
   ...
   private static function testCrossZ() : Boolean
   {
      ...
      if(_loc1_._1I_Q_(_loc2_) != Order._0m5)
      {
         return false;
      }
      if(_loc2_._1I_Q_(_loc1_) != Order._07T_)
      {
         return false;
      }
