package com.company.assembleegameclient.screens.charrects
{
   ...
   public class CharacterRect extends Sprite
   {
      ...
      private function drawBox(param1:Boolean) : void
      {
         ...
         this.box.graphics.beginFill(this.overColor);
      ...
      {
         this.classNameText = new SimpleText().setSize(18).setColor(16777215);
      ...
      protected function makeTaglineText(param1:_1eo) : void
      {
         this.taglineText = new SimpleText().setSize(14).setColor(11776947);
