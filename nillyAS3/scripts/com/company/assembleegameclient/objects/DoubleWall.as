package com.company.assembleegameclient.objects
{
   ...
   public class DoubleWall extends GameObject
   {
      ...
      private static const _0C_A_:Vector.<Number> = new <Number>[0,0,0,1,0,0,1,2,0,0,2,0];
      ...
      override public function draw(param1:Vector.<IGraphicsData>, param2:View, param3:int) : void
      {
         ...
         while(_loc8_ < this.faces_.length)
         {
            ...
            if(_loc6_ == null || _loc6_.texture_ == null || _loc6_ != null && _loc6_.obj_ is DoubleWall && !_loc6_.obj_.dying_)
            {
               _loc5_.isWall = true;
            }
            else
      ...
      public function _0hp() : void
      {
         ...
         this._1eV_(_loc1_,_loc2_,2,_loc1_ + 1,_loc2_,2);
         this._1eV_(_loc1_ + 1,_loc2_,2,_loc1_ + 1,_loc2_ + 1,2);
         this._1eV_(_loc1_ + 1,_loc2_ + 1,2,_loc1_,_loc2_ + 1,2);
         this._1eV_(_loc1_,_loc2_ + 1,2,_loc1_,_loc2_,2);
      }
      ...
      private function _1eV_(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number) : void
      {
         ...
         var _loc8_:Face3D = new Face3D(texture_,_loc7_,_0C_A_,true,true);
