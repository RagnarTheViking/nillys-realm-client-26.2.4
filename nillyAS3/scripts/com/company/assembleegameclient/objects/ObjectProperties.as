package com.company.assembleegameclient.objects
{
   ...
   public class ObjectProperties
   {
      ...
      public var groundDraw_:Boolean = false;
      ...
      public var bloodColor:uint = 16711680;
      
      public var shadowColor_:uint = 0;
      
      public var _R_q:Object = null;
      
      public var portrait_:com.company.assembleegameclient.objects._sV_ = null;
      ...
      public var whileMovingProps_:WhileMovingProperties = null;
      
      public var oldSound_:String = null;
      
      public var _0hB_:Dictionary;
      ...
      public function ObjectProperties(param1:XML)
      {
         ...
         for each(_loc2_ in param1.Projectile)
         {
            ...
            this._0hB_[_loc4_] = new ProjectileProperties(_loc2_);
         }
         ...
         {
            this.bloodColor = uint(param1.BloodColor);
         }
         ...
         for each(_loc3_ in param1.Sound)
         {
            ...
            this._R_q[int(_loc3_.@id)] = _loc3_.toString();
         }
         if(param1.hasOwnProperty("Portrait"))
         {
            this.portrait_ = new Portrait(XML(param1.Portrait));
         }
         if(param1.hasOwnProperty("WhileMoving"))
         {
            this.whileMovingProps_ = new WhileMovingProperties(XML(param1.WhileMoving));
         }
      }
      
      public function _Z_N_() : void
      {
